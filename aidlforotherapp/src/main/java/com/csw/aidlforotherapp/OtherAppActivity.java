package com.csw.aidlforotherapp;
...
public class OtherAppActivity extends AppCompatActivity{
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            String result = null;
            try {
                result = iService.hello("OtherAppActivity");
            ...
            try {
                ...
                Log.e("OtherAppActivity", book.toString());//打印出的内存地址与服务中打印的内存地址不同，说明这是两个对象，只是内容相同
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("OtherAppActivity");

        stringBuilder = new StringBuilder();
        addLog("start");
        addLog("connect remote service");
        Intent intent = new Intent();
        //隐式启动服务，需要制定服务包名与服务类名，还有Action，或者通过下面方法查找符合Action的服务
